...
@javax.annotation.Generated(
    ...
    comments = "Source: SumServices.proto")
public final class SumServiceGrpc {

  private SumServiceGrpc() {}

  public static final String SERVICE_NAME = "sum.services.grpc.SumService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<sum.services.grpc.SumServices.ClientRequestIntegersToSum,
      sum.services.grpc.SumServices.ServerResponseInteger> getOneToOneSumMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "oneToOneSum",
      requestType = sum.services.grpc.SumServices.ClientRequestIntegersToSum.class,
      responseType = sum.services.grpc.SumServices.ServerResponseInteger.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<sum.services.grpc.SumServices.ClientRequestIntegersToSum,
      sum.services.grpc.SumServices.ServerResponseInteger> getOneToOneSumMethod() {
    io.grpc.MethodDescriptor<sum.services.grpc.SumServices.ClientRequestIntegersToSum, sum.services.grpc.SumServices.ServerResponseInteger> getOneToOneSumMethod;
      ...
      synchronized (SumServiceGrpc.class) {
        if ((getOneToOneSumMethod = SumServiceGrpc.getOneToOneSumMethod) == null) {
          SumServiceGrpc.getOneToOneSumMethod = getOneToOneSumMethod =
              io.grpc.MethodDescriptor.<sum.services.grpc.SumServices.ClientRequestIntegersToSum, sum.services.grpc.SumServices.ServerResponseInteger>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "oneToOneSum"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sum.services.grpc.SumServices.ClientRequestIntegersToSum.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sum.services.grpc.SumServices.ServerResponseInteger.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<sum.services.grpc.SumServices.ClientRequestIntegersToSum,
      sum.services.grpc.SumServices.ServerResponseInteger> getOneToStreamSumMethod;
  ...
  public static io.grpc.MethodDescriptor<sum.services.grpc.SumServices.ClientRequestIntegersToSum,
      sum.services.grpc.SumServices.ServerResponseInteger> getOneToStreamSumMethod() {
    io.grpc.MethodDescriptor<sum.services.grpc.SumServices.ClientRequestIntegersToSum, sum.services.grpc.SumServices.ServerResponseInteger> getOneToStreamSumMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<sum.services.grpc.SumServices.ClientRequestIntegersToSum,
      sum.services.grpc.SumServices.ServerResponseInteger> getStreamToStreamSumMethod;
  ...
  public static io.grpc.MethodDescriptor<sum.services.grpc.SumServices.ClientRequestIntegersToSum,
      sum.services.grpc.SumServices.ServerResponseInteger> getStreamToStreamSumMethod() {
    io.grpc.MethodDescriptor<sum.services.grpc.SumServices.ClientRequestIntegersToSum, sum.services.grpc.SumServices.ServerResponseInteger> getStreamToStreamSumMethod;
  ...
  public static abstract class SumServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void oneToOneSum(sum.services.grpc.SumServices.ClientRequestIntegersToSum request,
        io.grpc.stub.StreamObserver<sum.services.grpc.SumServices.ServerResponseInteger> responseObserver) {
      asyncUnimplementedUnaryCall(getOneToOneSumMethod(), responseObserver);
    }

    /**
     */
    public void oneToStreamSum(sum.services.grpc.SumServices.ClientRequestIntegersToSum request,
        io.grpc.stub.StreamObserver<sum.services.grpc.SumServices.ServerResponseInteger> responseObserver) {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<sum.services.grpc.SumServices.ClientRequestIntegersToSum> streamToStreamSum(
        io.grpc.stub.StreamObserver<sum.services.grpc.SumServices.ServerResponseInteger> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                sum.services.grpc.SumServices.ClientRequestIntegersToSum,
                sum.services.grpc.SumServices.ServerResponseInteger>(
  ...
  public static final class SumServiceBlockingStub extends io.grpc.stub.AbstractStub<SumServiceBlockingStub> {
    ...
    /**
     */
    public sum.services.grpc.SumServices.ServerResponseInteger oneToOneSum(sum.services.grpc.SumServices.ClientRequestIntegersToSum request) {
    ...
    /**
     */
    public java.util.Iterator<sum.services.grpc.SumServices.ServerResponseInteger> oneToStreamSum(
        sum.services.grpc.SumServices.ClientRequestIntegersToSum request) {
  ...
  public static final class SumServiceFutureStub extends io.grpc.stub.AbstractStub<SumServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<sum.services.grpc.SumServices.ServerResponseInteger> oneToOneSum(
        sum.services.grpc.SumServices.ClientRequestIntegersToSum request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ONE_TO_ONE_SUM:
          serviceImpl.oneToOneSum((sum.services.grpc.SumServices.ClientRequestIntegersToSum) request,
              (io.grpc.stub.StreamObserver<sum.services.grpc.SumServices.ServerResponseInteger>) responseObserver);
          break;
        case METHODID_ONE_TO_STREAM_SUM:
          serviceImpl.oneToStreamSum((sum.services.grpc.SumServices.ClientRequestIntegersToSum) request,
              (io.grpc.stub.StreamObserver<sum.services.grpc.SumServices.ServerResponseInteger>) responseObserver);
          break;
        default:
  ...
  private static abstract class SumServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return sum.services.grpc.SumServices.getDescriptor();
    }
