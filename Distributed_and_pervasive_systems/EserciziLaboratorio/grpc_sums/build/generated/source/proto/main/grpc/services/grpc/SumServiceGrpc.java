...
public final class SumServiceGrpc {
  ...
  public static final String SERVICE_NAME = "services.grpc.SumService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<services.grpc.SumServices.ClientRequestIntegersToSum,
      services.grpc.SumServices.ServerResponseInteger> getOneToOneSumMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "oneToOneSum",
      requestType = services.grpc.SumServices.ClientRequestIntegersToSum.class,
      responseType = services.grpc.SumServices.ServerResponseInteger.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<services.grpc.SumServices.ClientRequestIntegersToSum,
      services.grpc.SumServices.ServerResponseInteger> getOneToOneSumMethod() {
    io.grpc.MethodDescriptor<services.grpc.SumServices.ClientRequestIntegersToSum, services.grpc.SumServices.ServerResponseInteger> getOneToOneSumMethod;
      ...
      synchronized (SumServiceGrpc.class) {
        if ((getOneToOneSumMethod = SumServiceGrpc.getOneToOneSumMethod) == null) {
          SumServiceGrpc.getOneToOneSumMethod = getOneToOneSumMethod =
              io.grpc.MethodDescriptor.<services.grpc.SumServices.ClientRequestIntegersToSum, services.grpc.SumServices.ServerResponseInteger>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "oneToOneSum"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  services.grpc.SumServices.ClientRequestIntegersToSum.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  services.grpc.SumServices.ServerResponseInteger.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<services.grpc.SumServices.ClientRequestIntegersToSum,
      services.grpc.SumServices.ServerResponseInteger> getOneToStreamSumMethod;
  ...
  public static io.grpc.MethodDescriptor<services.grpc.SumServices.ClientRequestIntegersToSum,
      services.grpc.SumServices.ServerResponseInteger> getOneToStreamSumMethod() {
    io.grpc.MethodDescriptor<services.grpc.SumServices.ClientRequestIntegersToSum, services.grpc.SumServices.ServerResponseInteger> getOneToStreamSumMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<services.grpc.SumServices.ClientRequestIntegersToSum,
      services.grpc.SumServices.ServerResponseInteger> getStreamToStreamSumMethod;
  ...
  public static io.grpc.MethodDescriptor<services.grpc.SumServices.ClientRequestIntegersToSum,
      services.grpc.SumServices.ServerResponseInteger> getStreamToStreamSumMethod() {
    io.grpc.MethodDescriptor<services.grpc.SumServices.ClientRequestIntegersToSum, services.grpc.SumServices.ServerResponseInteger> getStreamToStreamSumMethod;
  ...
  public static abstract class SumServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void oneToOneSum(services.grpc.SumServices.ClientRequestIntegersToSum request,
        io.grpc.stub.StreamObserver<services.grpc.SumServices.ServerResponseInteger> responseObserver) {
      asyncUnimplementedUnaryCall(getOneToOneSumMethod(), responseObserver);
    }

    /**
     */
    public void oneToStreamSum(services.grpc.SumServices.ClientRequestIntegersToSum request,
        io.grpc.stub.StreamObserver<services.grpc.SumServices.ServerResponseInteger> responseObserver) {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<services.grpc.SumServices.ClientRequestIntegersToSum> streamToStreamSum(
        io.grpc.stub.StreamObserver<services.grpc.SumServices.ServerResponseInteger> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                services.grpc.SumServices.ClientRequestIntegersToSum,
                services.grpc.SumServices.ServerResponseInteger>(
  ...
  public static final class SumServiceBlockingStub extends io.grpc.stub.AbstractStub<SumServiceBlockingStub> {
    ...
    /**
     */
    public services.grpc.SumServices.ServerResponseInteger oneToOneSum(services.grpc.SumServices.ClientRequestIntegersToSum request) {
    ...
    /**
     */
    public java.util.Iterator<services.grpc.SumServices.ServerResponseInteger> oneToStreamSum(
        services.grpc.SumServices.ClientRequestIntegersToSum request) {
  ...
  public static final class SumServiceFutureStub extends io.grpc.stub.AbstractStub<SumServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<services.grpc.SumServices.ServerResponseInteger> oneToOneSum(
        services.grpc.SumServices.ClientRequestIntegersToSum request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ONE_TO_ONE_SUM:
          serviceImpl.oneToOneSum((services.grpc.SumServices.ClientRequestIntegersToSum) request,
              (io.grpc.stub.StreamObserver<services.grpc.SumServices.ServerResponseInteger>) responseObserver);
          break;
        case METHODID_ONE_TO_STREAM_SUM:
          serviceImpl.oneToStreamSum((services.grpc.SumServices.ClientRequestIntegersToSum) request,
              (io.grpc.stub.StreamObserver<services.grpc.SumServices.ServerResponseInteger>) responseObserver);
          break;
        default:
  ...
  private static abstract class SumServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return services.grpc.SumServices.getDescriptor();
    }
